...
$result = "SELECT u.profile_pic, u.name, u.surname, r.id, r.reply_content, r.reply_date, r.user_id FROM users u, replies r WHERE u.id = r.user_id  AND topic_id = '".$_SESSION['SUB_ID']."' order by id DESC Limit $start, $perpage ";
...
<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
  ...
  $(document).on('focusin', function(e) {
   ...
   <script>
    ...
    {
      var x = confirm("Are you sure you want to delete this answer?");
      if (x)
          return true;
      else
        return false;
...
<div id='welcome'>
<div class="container" >
<h3 style="margin-top:10px; color:#00678F;margin-left:1%;"><?php echo $q; ?></h3>
</div>
</div>
...
$result = "SELECT count(*)  As Total from replies where topic_id = '".$_SESSION['SUB_ID']."'";


$qrycount1 = "SELECT count(*) As Total from replies where topic_id = '".$_SESSION['SUB_ID']."'";
...
echo "<span><a id='page_a_link' href='manage_answers.php?id={$g}&page=$j'> << </a></span>";
...
echo "<span><a id='page_a_link' href='manage_answers.php?id={$g}&page=$i'>$i</a></span>";
